...
const PROJECTS: Project[] = [
  {
    ...
    process: [
      ...
      "Truy cập ổ đĩa/thư mục: Ở cột bên trái, nhấp vào This PC, sau đó nhấp đúp vào một ổ đĩa không phải hệ thống (ví dụ: ổ D: hoặc E:). Nếu chỉ có ổ C:, hãy vào thư mục Documents.",
      "Tạo thư mục mới: Nhấp chuột phải vào một khoảng trống → chọn New → Folder. Đặt tên thư mục là ThucHanh_hotensinhvien (ví dụ: ThucHanh_NguyenPhuongLy). Nhấn Enter.",
      "Vào thư mục vừa tạo: Nhấp đúp vào thư mục ThucHanh_NguyenPhuongLy.",
      ...
      "Tạo thư mục con: Trong thư mục ThucHanh_NguyenPhuongLy, nhấp chuột phải → New → Folder. Đặt tên là TaiLieu.",
      ...
      "Di chuyển tệp tin (Cut & Paste): Quay lại thư mục ThucHanh_NguyenPhuongLy. Tạo một tệp mới tên là DiChuyen.txt. Nhấp chuột phải vào tệp DiChuyen.txt → chọn Cut (hoặc Ctrl + X). Nhấp đúp vào thư mục TaiLieu, nhấp chuột phải vào khoảng trống → chọn Paste (hoặc Ctrl + V). Tệp gốc biến mất khỏi vị trí cũ và chỉ còn ở vị trí mới.",
      ...
      "Xóa vĩnh viễn: Chọn tệp DiChuyen.txt, nhấn giữ phím Shift và nhấn phím Delete. Nếu đồng ý, tệp sẽ bị xóa vĩnh viễn mà không qua Thùng rác.",
      "Khôi phục từ Thùng rác (Tùy chọn): Mở Recycle Bin trên màn hình nền, tìm tệp GhiChuQuanTrong.txt đã xóa, nhấp chuột phải vào nó và chọn Restore. Tệp sẽ quay trở lại vị trí ban đầu.",
    ],
